...
ratel-js-utils 是一个js工具集合，无任何依赖，体积非小。

## 二、安装
```bash
#使用yarn
yarn add ratel-js-utils
#使用npm
npm install ratel-js-utils
```
...
```js
// commonjs
const {TreeTool, UuidTool, CommonTool} = require('ratel-js-utils')

// esm
import {TreeTool} from 'ratel-js-utils'

// 通过html标签引入
<script src="https://....../ratel-js-utils/dist/index.js"></script>
